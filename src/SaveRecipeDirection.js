    ...
    return (
        <View style={styles.screen} >
            ...
            <View style={styles.recipeImg}>
                ...
                <Image style={styles.image} source={{ uri: recipeData.imageSource }} />
                    ...
                    {activeSection === 'ingredients' ? (
                        ...
                        <View style={styles.ingredientsContainer}>
                            ...
                            <View style={styles.servingContainer}>
                                <Text style={styles.servingText}>Total Servings: {recipeData.serving}</Text>
...
export default SaveRecipeDirection