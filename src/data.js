export const data = [
    ...
    { id: '6',
     imageSource: 'https://storage.googleapis.com/makeiteasyrp808/2.jpg', description: 'Card 2', ingredients: ['ingredient4', 'ingredient5'], instructions: ['instru1', 'instru2', 'instru3'], ratings: [] },
    { id: '7', imageSource: 'https://storage.googleapis.com/makeiteasyrp808/3.jpg', description: 'Card 3', ingredients: ['ingredient4', 'ingredient5'], instructions: ['instru1', 'instru2', 'instru3'], ratings: [] },
    { id: '8', imageSource: 'https://storage.googleapis.com/makeiteasyrp808/4.jpg', description: 'Card 2', ingredients: ['ingredient4', 'ingredient5'], instructions: ['instru1', 'instru2', 'instru3'], ratings: [] },
    { id: '9', imageSource: 'https://storage.googleapis.com/makeiteasyrp808/1.jpg', description: 'Card 1', ingredients: ['ingredient1', 'ingredient2', 'ingredient3'], instructions: ['instru1', 'instru2', 'instru3'], ratings: [] },
    { id: '10', imageSource: 'https://storage.googleapis.com/makeiteasyrp808/2.jpg', description: 'Card 2', ingredients: ['ingredient4', 'ingredient5'], instructions: ['instru1', 'instru2', 'instru3'], ratings: [] },
